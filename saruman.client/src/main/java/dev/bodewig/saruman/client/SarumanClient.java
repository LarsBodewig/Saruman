...
public class SarumanClient {
  ...
  public static void unlockAchievement(
      SteamID userId, SteamUserStats userStats, String unlockCode, String keyPath)
  ...
  public SarumanClient(SteamID userId, SteamUserStats userStats, String keyPath)
  ...
  private static void unlockAchievement(
      SteamID userId, SteamUserStats userStats, String unlockCode, PublicKey publicKey)
  ...
  private static String decryptCode(String unlockCode, PublicKey publicKey)
      throws DecryptionException {
    try {
  ...
  private static String getAchievementNameFromCode(SteamID userId, String data)
      throws DecryptionException {
